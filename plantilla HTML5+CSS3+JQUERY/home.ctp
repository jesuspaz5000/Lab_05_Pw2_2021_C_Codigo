...
<html class="no-js"  lang="en">
	...
	<head>
		...
		<!-- favicon img -->
        <?php echo $this->Html->meta('favicon.png', 'img/assets/logo/favicon.png', ['type' => 'icon']);?>
		...
		<!--animate.css-->
		<?php echo $this->Html->css('assets/css/animate.css'); ?>
		<!--<link rel="stylesheet" href="assets/css/animate.css" />-->

		<!--hover.css-->
		<?php echo $this->Html->css('assets/css/hover-min.css'); ?>
		<!--<link rel="stylesheet" href="assets/css/hover-min.css" />-->

		<!--datepicker.css-->
		<?php echo $this->Html->css('assets/css/datepicker.css'); ?>
		<!--<link rel="stylesheet" href="assets/css/datepicker.css" />-->

		<!--owl.carousel.css-->
		<?php echo $this->Html->css('assets/css/owl.carousel.min.css'); ?>
		<!--<link rel="stylesheet" href="assets/css/owl.carousel.min.css" />-->
		<?php echo $this->Html->css('assets/css/owl.theme.default.min.css'); ?>
		<!--<link rel="stylesheet" href="assets/css/owl.theme.default.min.css" />-->

		<!-- range css-->
		<?php echo $this->Html->css('assets/css/jquery-ui.min.css'); ?>
		...
		<!-- bootsnav -->
		<?php echo $this->Html->css('assets/css/bootsnav.css'); ?>
	...
	<body>
							...
							<div class="main-menu">
								...
								<div class="collapse navbar-collapse">		  
									<ul class="nav navbar-nav navbar-right">
										<li class="smooth-menu"><a href="#home">Principal</a></li>
										<li class="smooth-menu"><a href="#gallery">Destino</a></li>
										<li class="smooth-menu"><a href="#pack">Paquetes </a></li>
										<li class="smooth-menu"><a href="#spo">Ofertas Especiales</a></li>
										<li class="smooth-menu"><a href="#blog">Blog</a></li>
										<li class="smooth-menu"><a href="#subs">Suscripción</a></li>
										<li>
											<button class="book-btn">reservar ahora
											</button>
										</li><!--/.project-btn--> 
									</ul>
								</div><!-- /.navbar-collapse -->
						...
						<div class="col-sm-12">
							<div class="single-about-us">
								<div class="about-us-txt">
									<h2>
										Explora la Belleza de este Hermoso Mundo 
													...
													<div class="single-tab-select-box">
														...
														<div class="travel-select-icon">
															<select class="form-control ">
															  	...
															  	<option value="default">Ingresa tu lugar de origen</option><!-- /.option-->
														...
														<div class="travel-select-icon">
															<select class="form-control ">
															  	...
															  	<option value="default">Ingresa tu lugar de destino</option><!-- /.option-->
			...
			<div class="container">
				...
				<div class="service-counter text-center">
					...
					<div class="col-md-4 col-sm-4">
						<div class="single-service-box">
							<div class="service-img">
								<?php echo $this->Html->image('assets/images/service/s1.png', ['alt' => 'service-icon']);?>
					...
					<div class="col-md-4 col-sm-4">
						<div class="single-service-box">
							<div class="service-img">
								<?php echo $this->Html->image('assets/images/service/s2.png', ['alt' => 'service-icon']);?>
					...
					<div class="col-md-4 col-sm-4">
						<div class="single-service-box">
							<div class="statistics-img">
								<?php echo $this->Html->image('assets/images/service/s3.png', ['alt' => 'service-icon']);?>
						  		...
						  		<div class="row">
						  			...
						  			<div class="col-md-6">
						  				<div class="filtr-item">
											<?php echo $this->Html->image('assets/images/gallary/g1.jpg', ['alt' => 'portfolio image']);?>
						  			...
						  			<div class="col-md-6">
						  				<div class="filtr-item">
											<?php echo $this->Html->image('assets/images/gallary/g2.jpg', ['alt' => 'portfolio image']);?>
						  			...
						  			<div class="col-md-4">
						  				<div class="filtr-item">
											<?php echo $this->Html->image('assets/images/gallary/g3.jpg', ['alt' => 'portfolio image']);?>
						  			...
						  			<div class="col-md-4">
						  				<div class="filtr-item">
											<?php echo $this->Html->image('assets/images/gallary/g4.jpg', ['alt' => 'portfolio image']);?>
						  			...
						  			<div class="col-md-4">
						  				<div class="filtr-item">
											<?php echo $this->Html->image('assets/images/gallary/g5.jpg', ['alt' => 'portfolio image']);?>
						  			...
						  			<div class="col-md-8">
						  				<div class="filtr-item">
											<?php echo $this->Html->image('assets/images/gallary/g6.jpg', ['alt' => 'portfolio image']);?>
					...
					<div class="row">
						...
						<div class="col-md-4 col-sm-6">
							<div class="single-package-item">
								<?php echo $this->Html->image('assets/images/packages/p1.jpg', ['alt' => 'package-place']);?>
						...
						<div class="col-md-4 col-sm-6">
							<div class="single-package-item">
								<?php echo $this->Html->image('assets/images/packages/p2.jpg', ['alt' => 'package-place']);?>
						...
						<div class="col-md-4 col-sm-6">
							<div class="single-package-item">
								<?php echo $this->Html->image('assets/images/packages/p3.jpg', ['alt' => 'package-place']);?>
						...
						<div class="col-md-4 col-sm-6">
							<div class="single-package-item">
								<?php echo $this->Html->image('assets/images/packages/p4.jpg', ['alt' => 'package-place']);?>
						...
						<div class="col-md-4 col-sm-6">
							<div class="single-package-item">
								<?php echo $this->Html->image('assets/images/packages/p5.jpg', ['alt' => 'package-place']);?>
						...
						<div class="col-md-4 col-sm-6">
							<div class="single-package-item">
								<?php echo $this->Html->image('assets/images/packages/p6.jpg', ['alt' => 'package-place']);?>
			...
			<div class="container">
				...
				<div class="owl-carousel owl-theme" id="testemonial-carousel">
					...
					<div class="home1-testm item">
						<div class="home1-testm-single text-center">
							<div class="home1-testm-img">
								<?php echo $this->Html->image('assets/images/client/testimonial1.jpg', ['alt' => 'img']);?>
					...
					<div class="home1-testm item">
						<div class="home1-testm-single text-center">
							<div class="home1-testm-img">
								<?php echo $this->Html->image('assets/images/client/testimonial2.jpg', ['alt' => 'img']);?>
						...
						<div class="col-sm-4">
							<div class="single-special-offer">
								<div class="single-special-offer-bg">
									<?php echo $this->Html->image('assets/images/offer/offer-shape.png', ['alt' => 'offer-shape']);?>
							...
							<div class="row">
								...
								<div class="col-sm-4 col-md-4">
									<div class="thumbnail">
										...
										<div class="thumbnail-img">
											<?php echo $this->Html->image('assets/images/blog/b1.jpg', ['alt' => 'blog-img']);?>
								...
								<div class="col-sm-4 col-md-4">
									<div class="thumbnail">
										<h2>trending news <span>15 november 2017</span></h2>
										<div class="thumbnail-img">
											<?php echo $this->Html->image('assets/images/blog/b2.jpg', ['alt' => 'blog-img']);?>
								...
								<div class="col-sm-4 col-md-4">
									<div class="thumbnail">
										<h2>trending news <span>15 november 2017</span></h2>
										<div class="thumbnail-img">
											<?php echo $this->Html->image('assets/images/blog/b3.jpg', ['alt' => 'blog-img']);?>
		...
		<!--modernizr.min.js-->
		<?php echo $this->Html->script('https://cdnjs.cloudflare.com/ajax/libs/modernizr/2.8.3/modernizr.min.js'); ?>
		...
		<!-- bootsnav js -->
		<?php echo $this->Html->script('assets/js/bootsnav.js'); ?>
		<!--<script src="assets/js/bootsnav.js"></script>-->

		<!-- jquery.filterizr.min.js -->
		<?php echo $this->Html->script('assets/js/jquery.filterizr.min.js'); ?>
		<!--<script src="assets/js/jquery.filterizr.min.js"></script>-->

		<?php echo $this->Html->script('https://cdnjs.cloudflare.com/ajax/libs/jquery-easing/1.4.1/jquery.easing.min.js'); ?>
		<!--<script src="https://cdnjs.cloudflare.com/ajax/libs/jquery-easing/1.4.1/jquery.easing.min.js"></script>-->

		<!--jquery-ui.min.js-->
		<?php echo $this->Html->script('assets/js/jquery-ui.min.js'); ?>
        ...
        <!-- jquery.sticky.js -->
		<?php echo $this->Html->script('assets/js/jquery.sticky.js'); ?>
		<!--<script src="assets/js/jquery.sticky.js"></script>-->

        <!--datepicker.js-->
		<?php echo $this->Html->script('assets/js/datepicker.js'); ?>
